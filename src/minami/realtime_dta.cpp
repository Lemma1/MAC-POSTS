...
MNM_Realtime_Dta::MNM_Realtime_Dta(std::string file_folder)
{
  ...
  m_before_shot = MNM::make_screenshot(file_folder, m_config, _tmp_link_factory, _tmp_node_factory, m_graph);
  m_after_shot = MNM::make_screenshot(file_folder, m_config, _tmp_link_factory, _tmp_node_factory, m_graph);
